...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "shopping-list",
        "reference": "workspace:shopping-list"
      }
    ],
    ...
    "fallbackExclusionList": [
      ["cart", ["workspace:cart"]],
      ["monorepo_playground", ["workspace:."]],
      ["shopping-list", ["workspace:shopping-list"]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["shopping-list", [
        ["workspace:shopping-list", {
          "packageLocation": "./shopping-list/",
          "packageDependencies": [
            ["shopping-list", "workspace:shopping-list"],
            ["cross-env", "npm:5.0.5"],
            ["lodash", "npm:4.17.21"]
